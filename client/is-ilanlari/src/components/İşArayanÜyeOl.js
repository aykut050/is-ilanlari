...
import './İşArayanÜyeOl.css';

class İşArayanÜyeOl extends Component {
    constructor(props){
        super(props);
        this.state = {
            username: '',
    ...
    signup() {
        if(this.state.username && this.state.password){
            PostData('signup_işçi',this.state).then((result) => {
    ...
    render() {
        ...
        return (
            <div class="üyeol-formu-bölümü-işarayan">
                <div class="başlık">
                    <i class="fas fa-user-plus"></i> İş Arayan Üye Olma
                </div>
                <div class="içerik">
                    <div class="form-container">
                        ...
                        <input type="password" id="password-input" placeholder="Şifre Tekrar" name="password" onChange={this.onChange} required />
