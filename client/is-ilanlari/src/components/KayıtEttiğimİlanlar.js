...
export default function KayıtEttiğimİlanlar() {
    ...
    const loadIlanlar = async () => {
        ...
        const result = await axios
            .get("http://localhost:8080/php-is-ilanlari/api/kayıtlı_ilan_al.php")
        await setIlan(result.data.ilan_kayıt.filter(x => x.işçi_id === data2))  
